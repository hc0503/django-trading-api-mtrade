    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('notional', models.DecimalField(decimal_places=20, max_digits=40)),
                ('weighted_avg_price', models.DecimalField(decimal_places=20, max_digits=40)),
                ('weighted_avg_yield', models.DecimalField(decimal_places=20, max_digits=40)),
                ('weighted_avg_spread', models.DecimalField(decimal_places=20, max_digits=40)),
                ...
                ('requestor', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='app_zero.institution')),
            ],
        ),
        migrations.CreateModel(
            name='Rfq',
            fields=[
                ...
                ('order_group', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='app_zero.ordergroup')),
            ],
        ),
        migrations.CreateModel(
            name='RfqResponse',
        ...
        migrations.AddField(
            model_name='coborder',
            name='order_group',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='app_zero.ordergroup'),
        ),
        migrations.AddField(
            model_name='coborder',
            name='security',
