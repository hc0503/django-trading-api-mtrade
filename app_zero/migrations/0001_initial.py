    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contract_id', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='institution_lead_contract', to='app_zero.file')),
                ('logo_id', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='institution_lead_logo', to='app_zero.file')),
            ],
            options={
                'abstract': False,
            },
