...
from app_zero.models import OrderGroup
...
class OrderGroupViewSet(CreateListUpdateRetrieveViewSet):
    ...
    serializer_class = ORDER_GROUP_ZERO_SERIALIZER
    filterset_fields = ('direction', 'security__isin', 'trader')
    ...
    def get_queryset(self):
        ...
        return ORDER_GROUP_ZERO_SERVICES.list_resources(self.request.user).order_by(order_by_string)
